...
type Props = {
  ...
  getDataThemeCharacterDetail: Function,
  dataThemeCharacterDetail: Object,
  match: {
    params: {
      id: string,
    },
...
const CharacterAudioBookDetail = ({
  ...
  useEffect(() => {
    getDataThemeCharacterDetail(themeId);
  }, [getDataThemeCharacterDetail, themeId]);
  ...
  const renderStrawberry =
    dataThemeCharacterDetail?.characters?.length > 0 ? (
      dataThemeCharacterDetail &&
      dataThemeCharacterDetail.characters &&
      dataThemeCharacterDetail.characters.map((item, index) => {
          ...
          <div
            ...
            onClick={() =>
              ...
              handleChangeOption(
                ...
                dataThemeCharacterDetail &&
                  dataThemeCharacterDetail.characters &&
                  dataThemeCharacterDetail.characters[index]
              )
            }
            tabIndex={0}
            role="button"
  ...
  return (
    <MainLayout
      customClass="character"
      titleHeader={dataThemeCharacterDetail.title}
      isShowHeader
      isLink
      isShowIcon
    >
        ...
        <div className="strawberry">
          <div className="strawberry__titleThemes">
            <div className="strawberry__titleThemes__left">
              <img
                src={
                  `https://down.wjthinkbig.com${dataThemeCharacterDetail?.mainThumbnailUrl}` ||
                  IMAGES.image_not_found
                }
                alt="img"
                onError={(e) => {
            ...
            <div className="strawberry__titleThemes__right">
              <p className="content-act">
                {dataThemeCharacterDetail.description}
              </p>
            </div>
          </div>
          ...
          {dataThemeCharacterDetail?.characters?.length > 0 && (
            <div className="strawberry__top strawberry-dj-top">
              <div className="strawberry__top__total">
                ...
                {dataThemeCharacterDetail &&
                  dataThemeCharacterDetail.characters &&
                  dataThemeCharacterDetail.characters.length.toLocaleString(
                    'en'
                  )}
                개
              </div>
              <div className="strawberry__top__chooseOption">
                <p
                  onClick={() => {
                    getListAudio(dataThemeCharacterDetail?.characters);
                    setListAudio([]);
