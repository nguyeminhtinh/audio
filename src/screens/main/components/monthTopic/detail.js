...
type Props = {
  ...
  getDataThemeMonthDetail: Function,
  dataThemeMonthDetail: Object,
...
const MonthTopicDetail = ({
  ...
  // call api get theme Month
  useEffect(() => {
    getDataThemeMonthDetail(themeId);
  }, [getDataThemeMonthDetail, themeId]);
  ...
  const renderStrawberry =
    dataThemeMonthDetail?.months?.length > 0 ? (
      dataThemeMonthDetail &&
      dataThemeMonthDetail.months &&
      dataThemeMonthDetail.months.map((item, index) => {
          ...
          <div
            ...
            onClick={() =>
              ...
              handleChangeOption(
                ...
                dataThemeMonthDetail &&
                  dataThemeMonthDetail.months &&
                  dataThemeMonthDetail.months[index]
              )
            }
            tabIndex={0}
            role="button"
        ...
        <div className="strawberry">
          <div className="strawberry__titleThemes">
            <div className="strawberry__titleThemes__left">
              <img
                src={
                  `https://down.wjthinkbig.com${dataThemeMonthDetail?.mainThumbnailUrl}` ||
                  IMAGES.image_not_found
                }
                alt=""
                onError={(e) => {
            ...
            <div className="strawberry__titleThemes__right">
              <h2>{dataThemeMonthDetail?.title}</h2>
              <p>{dataThemeMonthDetail?.description}</p>
            </div>
          </div>
          ...
          {dataThemeMonthDetail?.months?.length > 0 && (
            <div className="strawberry__top strawberry-dj-top">
              <div className="strawberry__top__total">
                ...
                {dataThemeMonthDetail &&
                  dataThemeMonthDetail.months &&
                  dataThemeMonthDetail.months.length.toLocaleString('en')}
                개
              </div>
              <div className="strawberry__top__chooseOption">
                <p
                  onClick={() => {
                    getListAudio(dataThemeMonthDetail?.months);
                    setListAudio([]);
...
export default memo<Props>(MonthTopicDetail);
